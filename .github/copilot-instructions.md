...
Use the existing documentation to understand architecture, standards, and workflow expectations:
...
- Systematic Debugging: Use test failures as implementation guides.
...
- tdd-developer: Use for implementation and unit or integration TDD cycles; do NOT create or run Playwright UI tests in this mode.
- code-reviewer: Use for lint error resolution and broader code quality improvements.
